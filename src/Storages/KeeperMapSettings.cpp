...
DECLARE_SETTINGS_TRAITS(KeeperMapSettingsTraits, KEEPER_MAP_SETTINGS, KEEPER_MAP_SETTINGS_SUPPORTED_TYPES)
IMPLEMENT_SETTINGS_TRAITS(KeeperMapSettingsTraits, KEEPER_MAP_SETTINGS, KeeperMapSettings, KeeperMapSetting)
...
bool KeeperMapSettings::hasBuiltin(std::string_view name)
{
    return KeeperMapSettingsImpl::hasBuiltin(name);
}
}
