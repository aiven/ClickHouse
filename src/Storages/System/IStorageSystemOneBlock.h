...
public:
    explicit IStorageSystemOneBlock(const StorageID & table_id_, ColumnsDescription columns_description) : StorageWithCommonVirtualColumns(table_id_, nullptr, std::nullopt)
    {
