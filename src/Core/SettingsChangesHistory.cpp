...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "24.8",
        {
            ...
            {"enable_time_series_table", false, false, "Renamed from allow_experimental_time_series_table, which stays as an alias"},
            {"enable_time_series_aggregate_functions", false, false, "Renamed from allow_experimental_time_series_aggregate_functions"},
            {"time_series_prefer_recent_samples_table", true, true, "New setting: prefer the recent samples table when the requested range fits its TTL window"},
