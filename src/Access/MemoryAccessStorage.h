...
private:
    ...
    bool insertNoLock(const UUID & id, const AccessEntityPtr & entity, bool replace_if_exists, bool throw_if_exists, UUID * conflicting_id, bool notify = true, const CheckFunc & check_func = {});
    bool removeNoLock(const UUID & id, bool throw_if_not_exists, bool notify = true, const CheckFunc & check_func = {});
