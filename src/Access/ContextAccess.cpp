...
AccessRights ContextAccess::addImplicitAccessRights(const AccessRights & access, const AccessControl & access_control)
{
    ...
    {
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "aggregate_function_combinators");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "asynchronous_inserts", "database");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "asynchronous_inserts", "entries.bytes");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "asynchronous_inserts", "entries.query_id");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "asynchronous_inserts", "first_update");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "asynchronous_inserts", "format");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "asynchronous_inserts", "table");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "asynchronous_inserts", "total_bytes");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "asynchronous_metrics");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "azure_queue", "exception");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "azure_queue", "file_name");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "azure_queue", "file_path");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "azure_queue", "processing_end_time");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "azure_queue", "processing_start_time");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "azure_queue", "rows_processed");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "azure_queue", "status");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "azure_queue_settings");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "backups");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "clusters");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "collations");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "columns");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "contributors");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "current_roles");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "data_skipping_indices");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "data_type_families");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "databases");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "detached_parts");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "detached_tables");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "dictionaries");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "disks");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "distributed_ddl_queue", "cluster");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "distributed_ddl_queue", "entry");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "distributed_ddl_queue", "entry_version");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "distributed_ddl_queue", "exception_code");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "distributed_ddl_queue", "exception_text");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "distributed_ddl_queue", "host");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "distributed_ddl_queue", "initiator_host");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "distributed_ddl_queue", "initiator_port");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "distributed_ddl_queue", "port");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "distributed_ddl_queue", "query_create_time");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "distributed_ddl_queue", "query_duration_ms");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "distributed_ddl_queue", "query_finish_time");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "distributed_ddl_queue", "settings");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "distributed_ddl_queue", "status");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "distribution_queue");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "dropped_tables");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "enabled_roles");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "errors");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "events");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "filesystem_cache");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "filesystem_cache_settings");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "formats");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "functions");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "grants");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "graphite_retentions");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "jemalloc_bins");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "kafka_consumers");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "licenses");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "macros");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "merge_tree_settings");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "merges");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "metrics");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "moves");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "mutations", "block_numbers.number");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "mutations", "block_numbers.partition_id");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "mutations", "create_time");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "mutations", "database");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "mutations", "is_done");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "mutations", "is_killed");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "mutations", "latest_fail_error_code_name");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "mutations", "latest_fail_reason");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "mutations", "latest_fail_time");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "mutations", "latest_failed_part");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "mutations", "mutation_id");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "mutations", "parts_to_do");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "mutations", "parts_to_do_names");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "mutations", "table");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "named_collections", "create_query");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "named_collections", "name");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "named_collections", "source");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "numbers");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "numbers_mt");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "one");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "part_moves_between_shards");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "parts");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "parts_columns");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "privileges");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "processes");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "projections");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "projection_parts");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "projection_parts_columns");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "query_cache");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "query_condition_cache", "condition_hash");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "query_condition_cache", "entry_size");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "query_condition_cache", "matching_marks");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "query_condition_cache", "part_name");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "query_condition_cache", "table_uuid");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "query_log");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "query_views_log");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "part_log");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "asynchronous_insert_log");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "resources");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "s3_queue_settings");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "text_log");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "quota_limits");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "quota_usage");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "quotas");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "quotas_usage");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "remote_data_paths", "cache_base_path");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "remote_data_paths", "cache_paths");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "remote_data_paths", "disk_name");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "remote_data_paths", "local_path");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "remote_data_paths", "path");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "remote_data_paths", "size");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "replicas");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "replicated_fetches");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "replicated_merge_tree_settings");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "replication_queue");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "role_grants");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "roles");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "row_policies");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "schema_inference_cache");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "server_settings");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "settings");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "settings_changes");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "settings_profile_elements");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "settings_profiles");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "storage_policies");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "table_engines");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "table_functions");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "tables");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "trace_log");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "time_zones");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "user_processes");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "users");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "zeros");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "zeros_mt");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "zookeeper_connection");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "asynchronous_loader");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "dashboards");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "database_engines");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "dropped_tables_parts");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "keywords");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "s3queue");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "scheduler");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "view_refreshes");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "workloads");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "codecs");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "completions");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "dead_letter_queue");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "dimensional_metrics");
        res.grant(AccessType::SELECT, DatabaseCatalog::SYSTEM_DATABASE, "iceberg_history");
    }
