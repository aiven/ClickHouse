...
private:
    ...
    bool insertNoLock(const UUID & id, const AccessEntityPtr & new_entity, bool replace_if_exists, bool throw_if_exists, UUID * conflicting_id, bool write_on_disk, const CheckFunc & check_func = {}) TSA_REQUIRES(mutex);
    ...
    bool removeNoLock(const UUID & id, bool throw_if_not_exists, bool write_on_disk, const CheckFunc & check_func = {}) TSA_REQUIRES(mutex);
