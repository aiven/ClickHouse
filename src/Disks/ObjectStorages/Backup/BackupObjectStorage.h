...
public:
    ...
    virtual void removeObjectsIfExist(const StoredObjects & objects) override;
    ...
    bool areObjectKeysRandom() const override { return object_storage->areObjectKeysRandom(); }
