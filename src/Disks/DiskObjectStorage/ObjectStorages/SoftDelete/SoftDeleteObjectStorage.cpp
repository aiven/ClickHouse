...
void SoftDeleteObjectStorage::removeObjectsIfExist(const StoredObjects & objects, StoredObjects * successful_objects)
{
    for (const auto & object : objects)
    {
        ...
        /// A written marker is the completed removal from the caller's point of view: the blob is
        /// invisible to `exists` and to listings, and physical deletion belongs to the external GC.
