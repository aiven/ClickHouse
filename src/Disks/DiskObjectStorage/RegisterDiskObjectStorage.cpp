...
void registerDiskObjectStorage(DiskFactory & factory, bool global_skip_access_check)
{
    ...
    auto register_type = [&](const String & disk_type, Documentation documentation)
    {
        factory.registerDiskType(disk_type, creator, std::move(documentation));
        factory.markSoftDeleteCapable(disk_type);
    };

    register_type("object_storage", Documentation{
...
#if USE_AWS_S3
    register_type("s3", Documentation{
    ...
    register_type("s3_plain", Documentation{
    ...
    register_type("s3_with_keeper", Documentation{
    ...
    register_type("s3_plain_rewritable", Documentation{
...
#endif
#if USE_HDFS
    register_type("hdfs", Documentation{
    ...
    register_type("azure_blob_storage", Documentation{
        ...
        .related = {"object_storage"}}); /// For compatibility
#endif
    register_type("local_blob_storage", Documentation{
    ...
    register_type("web", Documentation{
