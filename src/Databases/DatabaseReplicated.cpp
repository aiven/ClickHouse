...
namespace ServerSetting
{
    ...
    extern const ServerSettingsUInt32 replicated_database_logs_to_keep;
}
...
bool DatabaseReplicated::createDatabaseNodesInZooKeeper(const zkutil::ZooKeeperPtr & current_zookeeper)
{
    ...
    auto logs_to_keep = getContext()->getServerSettings()[ServerSetting::replicated_database_logs_to_keep];
