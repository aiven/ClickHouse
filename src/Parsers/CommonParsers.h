...
#define APPLY_FOR_PARSER_KEYWORDS(MR_MACROS) \
    ...
    MR_MACROS(DEFAULT_REPLICATED_DATABASE_PRIVILEGES, "DEFAULT REPLICATED DATABASE PRIVILEGES") \
    ...
    MR_MACROS(IN, "IN") \
    MR_MACROS(INCREMENTAL, "INCREMENTAL") \
    ...
    MR_MACROS(METRIC_FAMILIES, "METRIC FAMILIES") \
