...
| 26.3-aiven | (none — proposed DROP; see §2) | T3.1 worker, dispatch 2026-05-22 | drift-superseded (proposed) |

The 26.3-aiven row stays "(none — proposed DROP)" until the human accepts or rejects
the proposal recorded in §2. If the human rejects the drop, the row becomes
"(staged)" pending re-dispatch with an alternative test design.
