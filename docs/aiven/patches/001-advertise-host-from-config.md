...
| 26.3-aiven | **(no carry — `obsoleted-by-upstream`)** | T3.8 parent preflight (this dispatch) | `obsoleted-by-upstream` — upstream `9dd658aea06` landed semantically-identical fix; see §2 |
