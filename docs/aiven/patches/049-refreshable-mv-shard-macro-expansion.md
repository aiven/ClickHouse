...
| 26.3-aiven | (staged) | T3.13 worker (source + scaffold), T3.14 worker (test redesign + evidence) | byte-equivalent cherry-pick; integration test with verified pre/post evidence pair (T3.14 redesign per (iv) reachability proof) |
