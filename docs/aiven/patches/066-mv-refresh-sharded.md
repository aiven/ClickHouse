...
> **Status: single-node neutrality RESTORED (staged, not committed).** The
...
| 26.3-aiven | (staged, one squashed commit) | Cursor agent (patch-066 dispatch) | conflict-resolved + 5 defect fixes; **single-node neutrality restored** |
